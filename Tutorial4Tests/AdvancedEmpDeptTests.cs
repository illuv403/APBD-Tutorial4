...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps.Select(emp => emp.Mgr != null).ToList(); 
        
        Assert.All(withMgr, mgr => Assert.NotNull(mgr));
    }
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        ...
        var result = emps.Select(emp => emp.Sal > 500); 
        
        Assert.True(result.All(emp => emp));
    }
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = from emp in emps
            ...
            select new { emp.EName, Total = totalIncome };
